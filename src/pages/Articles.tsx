    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 pb-12 px-6 md:px-10 max-w-5xl mx-auto text-center">
        ...
        <p className="font-body text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Analyzing market shifts, sustainable logistics, and the future of
          industrial procurement through an ethereal architectural lens.
        </p>
      </section>
      ...
      <section className="px-6 md:px-10 max-w-3xl mx-auto pb-24 text-center">
        <div className="ghost-border rounded-xl bg-surface-container-low p-8 md:p-12">
          ...
          <p className="font-body text-xs text-muted-foreground mb-6">
            Weekly insights delivered directly to your executive suite. No
            clutter, just intelligence.
          </p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <button
              type="submit"
              className="h-10 px-6 bg-primary text-primary-foreground font-body text-xs tracking-wider uppercase rounded-xl hover:bg-primary/90 transition-colors"
            >
              Subscribe
            </button>
          </form>
